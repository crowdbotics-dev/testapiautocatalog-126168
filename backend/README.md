...
## Project Structure
    ...
    ├── testapiautocatalog_126168  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_126168`
...
2. Clone this repo and `cd testapiautocatalog_126168`
